    ...
    <aside className="hidden xl:flex flex-col w-80 p-4 pl-8 sticky top-0 h-screen">
      <div className="space-y-6">
        ...
        <input 
          type="text" 
          placeholder="Search..." 
          className="w-full bg-surface border border-border p-2 text-sm text-text-primary placeholder-text-secondary focus:outline-none focus:border-primary"
        />

        {/* Trends Placeholder */}
        <div className="bg-surface border border-border">
          <h3 className="font-bold p-3 border-b border-border text-text-primary">What’s happening</h3>
        ...
        <div className="bg-surface border border-border">
          <h3 className="font-bold p-3 border-b border-border text-text-primary">Who to follow</h3>
          <div className="p-3 space-y-3 text-sm">
            <div className="flex justify-between items-center">
                <p className="text-text-primary font-semibold">Placeholder User</p>
                <button className="bg-primary text-white px-3 py-1 text-xs font-bold">Follow</button>
            </div>
            <div className="flex justify-between items-center">
